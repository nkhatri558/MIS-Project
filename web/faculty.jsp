                                ...
                                <form id="facultyForm" method="POST">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input name="facultyName" type="text" id="inputFaculty" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input id="submitBtn" type="submit" value="Add New Faculty" class="btn btn-success float-right">
                                        </div>
