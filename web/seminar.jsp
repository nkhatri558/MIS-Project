                                ...
                                <form id="seminarForm" method="POST">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input placeholder="Enter Seminar Title" name="seminarTitle" type="text" id="inputSeminarTitle" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="inputBatch" class="form-control custom-select" name="batch">
                                                
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <input id="submitBtn" type="submit" value="Add" class="btn btn-success float-right" >
                                        </div>
