...
<html>
    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <input type="hidden" id="studentId" value="${sessionScope.student.studentId}"/>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputRollNumber" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputFullName">Full Name</label>
                                                                    <input disabled type="text" class="form-control" id="inputFullName" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputFatherName" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputLegalId">Legal ID</label>
                                                                    <input disabled type="text" class="form-control" id="inputLegalId" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputLegalIdNo" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputNationality">Nationality</label>
                                                                    <input disabled type="text" class="form-control" id="inputNationality" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputPlaceOfIssueOfLegalId" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputDateOfIssueOfLegalId">Date of Issue of Legal ID</label>
                                                                    <input disabled type="date" class="form-control" id="inputDateOfIssueOfLegalId" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="date" class="form-control" id="inputDob" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputDomicile" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputCountryOfBirth" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputBloodGroup">Blood Group</label>
                                                                    <input disabled type="text" class="form-control" id="inputBloodGroup" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputReligion" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputAddress">Address</label>
                                                                    <input type="text" class="form-control" id="inputAddress" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="inputCurrentAddress" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>    
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="inputSemester" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputDepartment">Deparment</label>
                                                                    <input disabled type="text" class="form-control" id="inputDepartment" placeholder="Nand Lal">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputBatch" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputAdmissionDate">Admission Date</label>
                                                                    <input disabled type="text" class="form-control" id="inputAdmissionDate" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputSupervisor" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputProgram">Program</label>
                                                                    <input disabled type="text" class="form-control" id="inputProgram" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputFieldProgram" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputShift">Shift</label>
                                                                    <input disabled type="text" class="form-control" id="inputShift" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputTiming" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputMatriculationPassingYear" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputMatriculationBoard">Board</label>
                                                                    <input disabled type="text" class="form-control" id="inputMatriculationBoard" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputMatriculationMarks" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputMatriculationSubject">Subject</label>
                                                                    <input disabled type="text" class="form-control" id="inputMatriculationSubject" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputIntermediatePassingYear" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputIntermediateBoard">Board</label>
                                                                    <input disabled type="text" class="form-control" id="inputIntermediateBoard" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputIntermediateMarks" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputIntermediateSubject">Subject</label>
                                                                    <input disabled id="inputIntermediateSubject" type="text" class="form-control" id="inputIntermediateSubject" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputGraduatePassingYear" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputGraduateUniversity">University</label>
                                                                    <input disabled type="text" class="form-control" id="inputGraduateUniversity" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" class="form-control" id="inputGraduateCgpa" placeholder="19ME-SW101">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="inputGraduateDegreeProgram">Degree Program</label>
                                                                    <input disabled type="text" class="form-control" id="inputGraduateDegreeProgram" placeholder="Nand Lal">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
